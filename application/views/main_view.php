    ...
    <section class="shop__filter filter">
      ...
      <div class="filter__wrapper">
        ...
        <ul class="filter__list">
          ...
          <li>
            <a class="filter__list-item" href="/main/women">Женщины</a>
          </li>
          <li>
            <a class="filter__list-item" href="/main/men">Мужчины</a>
          </li>
          <li>
            <a class="filter__list-item" href="/main/children">Дети</a>
          </li>
          <li>
            <a class="filter__list-item" href="/main/accessories">Аксессуары</a>
          </li>
        </ul>
      </div>
        <div class="filter__wrapper">
        ...
        ?>
          <article class="shop__item product" tabindex="0">
            <div class="product__image">
              <img src="/img/products/<?=$row['image_path']?>.jpg" alt="product-name">
            </div>
